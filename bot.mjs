...
function isValidInput(input) {
  ...
  // Украинский номер латиницей (различные форматы)
...
💡 VIN-код должен содержать 17 символов, номер - стандартный украинский формат латиницей.
  `;
...
• Госномер: украинский формат латиницей (например, AA1234BB)
